...
function fifes_dump_html_tree($node, $show_attr = true, $deep = 0)
{
    $node->dump($node);
}

class fifes_simple_html_dom_node
{
...
class fifes_simple_html_dom
{
        ...
        $defaultSpanText = DEFAULT_SPAN_TEXT)
    {
        ...
        $this->root = new fifes_simple_html_dom_node($this);
        $this->root->tag = 'root';
    ...
    protected function parse()
    {
        while (true) {
            ...
            $node = new fifes_simple_html_dom_node($this);
            ++$this->cursor;
